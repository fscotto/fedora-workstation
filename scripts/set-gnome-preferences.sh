...
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Utilities/ apps "['org.gnome.baobab.desktop', 'org.gnome.Evince.desktop', 'org.gnome.Loupe.desktop', 'org.fedoraproject.MediaWriter.desktop', 'org.raspberrypi.rpi-imager.desktop', 'org.gnome.Characters.desktop', 'org.gnome.font-viewer.desktop', 'simple-scan.desktop', 'nl.hjdskes.gcolor3.desktop', 'nvim.desktop', 'fish.desktop', 'ranger.desktop', 'htop.desktop', 'btop.desktop', 'yelp.desktop', 'org.gnome.Tour.desktop', 'org.freedesktop.GnomeAbrt.desktop', 'nwg-panel-config.desktop', 'org.pulseaudio.pavucontrol.desktop', 'rofi.desktop', 'rofi-theme-selector.desktop']"
...
gsettings set org.gnome.shell app-picker-layout "[{'02123af2-796e-4d92-90cb-58ec32548cde': <{'position': <0>}>, 'Utilities': <{'position': <1>}>, 'ebe9c514-6000-498c-b613-cdc4b223d5e2': <{'position': <2>}>, 'filezilla.desktop': <{'position': <3>}>, 'uk.org.greenend.chiark.sgtatham.putty.desktop': <{'position': <4>}>, 'org.freefilesync.FreeFileSync.desktop': <{'position': <5>}>, 'org.freefilesync.FreeFileSync.RealTimeSync.desktop': <{'position': <6>}>, 'org.gnome.Boxes.desktop': <{'position': <7>}>, 'org.gnome.Contacts.desktop': <{'position': <8>}>, 'org.gnome.Weather.desktop': <{'position': <9>}>, 'org.gnome.clocks.desktop': <{'position': <10>}>, 'org.gnome.Maps.desktop': <{'position': <11>}>, 'org.gnome.Calendar.desktop': <{'position': <12>}>, 'org.gnome.Snapshot.desktop': <{'position': <13>}>, 'org.gnome.Calculator.desktop': <{'position': <14>}>, 'org.gnome.TextEditor.desktop': <{'position': <15>}>, 'qalculate-gtk.desktop': <{'position': <16>}>, 'io.dbeaver.DBeaverCommunity.desktop': <{'position': <17>}>, 'org.videolan.VLC.desktop': <{'position': <18>}>, 'com.github.xournalpp.xournalpp.desktop': <{'position': <19>}>, 'com.usebruno.Bruno.desktop': <{'position': <20>}>, 'codium.desktop': <{'position': <21>}>}]"
gsettings set org.gnome.shell favorite-apps "['org.gnome.Nautilus.desktop', 'org.mozilla.firefox.desktop', 'org.mozilla.Thunderbird.desktop', 'org.telegram.desktop.desktop', 'com.spotify.Client.desktop', 'intellij-idea-ultimate.desktop', 'postman.desktop', 'io.podman_desktop.PodmanDesktop.desktop', 'org.gnome.Meld.desktop', 'me.iepure.devtoolbox.desktop', 'kitty.desktop']"
